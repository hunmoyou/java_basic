...
//System.out.printf("정사각형의 넓이: %d", a*a);
//return;
//}
//
//void calcRectArea(int b, int c) {
//System.out.printf("직사각형의 넓이: %d", b*c);
//return;
//}
//
//void calcRectArea(int d, int e, int f) {//d*e*f/2
//System.out.printf("사다리꼴 넓이: %d", (d+e)*f/2);
//return;
//}
//희수형이 알려준거
//int calcRectArea(int r){
