...
public class Identifier {
	...
	public static void main(String[] args) {
	  ...
	  //int age = 40; (x)
		...
		//int 700 = 365; (x) 좌항에 숫자가 아닌 변수가 와야한다.
		//int 7number = 7; (x) //변수는 숫자로 시작해서는 안된다
		int number7 = 7;
		int num7ber = 7;
		int num12345ber = 123;
		
		//3. 식별자 이름에 공백을 표함할 수 없습니다.
...
//		String class = "클래스"; 예약어는 식별자 이름으로 지정하면 안된다.
		String Class = "클래스"; //사용가능하나 권장하지 않는다.
